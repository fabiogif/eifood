...
Route::prefix('admin')
    ...
    ->group(function () {
        ...
        //Product X Category
        Route::get('/products/{id}/category/{idCategory}/detach', [App\Http\Controllers\Admin\CategoryProductController::class, 'detachCategoriesProduct'])->name('products.categories.detach');
        Route::post('/products/{id}/categories', [App\Http\Controllers\Admin\CategoryProductController::class, 'attachCategoriesProduct'])->name('products.categories.attach');
        Route::any('/products/{id}/categories/create', [App\Http\Controllers\Admin\CategoryProductController::class, 'categoriesAvailable'])->name('products.categories.available');
        Route::get('/products/{id}/categories', [App\Http\Controllers\Admin\CategoryProductController::class, 'categories'])->name('products.categories');
        Route::get('/categories/{id}/products', [App\Http\Controllers\Admin\CategoryProductController::class, 'plans'])->name('categories.plans');
