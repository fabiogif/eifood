                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td>{{ $product->price }}</td>
                            <td style=" width: 10px">
                                <a href="{{ route('products.categories', $product->id) }}" title="Categorias"
                                    alt="Categorias" class="btn btn-warning"><i class="fas fa-layer-group"></i></a>
                                <a href="{{ route('products.edit', $product->id) }}" title="Alterar"
                                    class="btn btn-warning"><i class="fas fa-edit"></i></a>
                                <a href="{{ route('products.show', $product->id) }}" title="Detalhes"
